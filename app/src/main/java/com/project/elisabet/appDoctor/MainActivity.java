...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void checkLocationEnabled(){
        ...
        if(!gps_enabled && !network_enabled) {
            ...
            new AlertDialog.Builder(MainActivity.this)
                    .setTitle(R.string.xarxa_gps_descativada)
                    .setMessage(R.string.gps_continue)
                    .setPositiveButton(R.string.obre_gps_opcions, new DialogInterface.OnClickListener() {
                        @Override
    ...
    private void discoverDevices() {
        mManager.discoverPeers(mChannel, new WifiP2pManager.ActionListener() {
            @Override
            public void onSuccess() {
                connectionStatus.setText(getString(R.string.començar_cerca));
            }

            @Override
            public void onFailure(int reason) {
                connectionStatus.setText(getString(R.string.error_cerca));
            }
        });
    }
    ...
    WifiP2pManager.PeerListListener peerListListener = new WifiP2pManager.PeerListListener() {
        ...
        public void onPeersAvailable(WifiP2pDeviceList peersList) {
            ...
            if(peersList.getDeviceList().size() == 0){
                Toast.makeText(getApplicationContext(), getString(R.string.no_connexions_peer), Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void toggleWifiState() {
        if(wifiManager.isWifiEnabled()){
            ...
            menu.findItem(R.id.wifi_toggle).setTitle(getString(R.string.activa_wifi));
        }else{
            wifiManager.setWifiEnabled(true);
            menu.findItem(R.id.wifi_toggle).setTitle(getString(R.string.desactiva_wifi));
        }
    }
